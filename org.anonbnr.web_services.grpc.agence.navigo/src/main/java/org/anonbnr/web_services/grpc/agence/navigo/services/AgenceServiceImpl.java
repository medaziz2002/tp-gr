package org.anonbnr.web_services.grpc.agence.navigo.services;
...
import org.anonbnr.web_services.grpc.agence.navigo.entity.*;
import org.anonbnr.web_services.grpc.agence.navigo.repository.AgenceRepository;
import org.anonbnr.web_services.grpc.agence.navigo.repository.ClientAgenceRepository;
import org.anonbnr.web_services.grpc.agence.navigo.repository.ClientRepository;
...
public class AgenceServiceImpl extends NavigoServiceGrpc.NavigoServiceImplBase {
    ...
    public void createUser(CreateUserRequest request, StreamObserver<CreateUserResponse> responseObserver) {
        try {
            ...
            if (request.getUsername().isEmpty() || request.getPassword().isEmpty() || request.getName().isEmpty()) {
                ...
                throw new IllegalArgumentException("All fields are required: username, password, name.");
            }

            // Check if the username already exists
            if (clientAgenceRepository.existsByUsername(request.getUsername())) {
                logger.error("Username {} is already taken.", request.getUsername());
                throw new IllegalArgumentException("The username is already taken: " + request.getUsername());
            }
            ...
            // Save the client-agency relationship
            ...
            // Detect specific exceptions like duplicates
            if (e.getCause() instanceof org.hibernate.exception.ConstraintViolationException) {
                responseObserver.onError(Status.ALREADY_EXISTS
                        .withDescription("Duplicate username detected: " + request.getUsername())
                        .asRuntimeException());
                ...
                responseObserver.onError(Status.INTERNAL
                        .withDescription("An unexpected error occurred while creating the user.")
                        .withCause(e)
                        .asRuntimeException());
            }
        }
